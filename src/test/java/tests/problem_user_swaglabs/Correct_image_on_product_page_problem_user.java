package tests.problem_user_swaglabs;
...
public class Correct_image_on_product_page_problem_user extends BaseTest {
     ...
     */
    @Test
    public void correct_image_on_product_page_problem_user() throws IOException, InterruptedException {

        /** Откроем страницу отображаемого изображения (в нашем случае это изображение первого товара) */


        basePage.open("https://www.saucedemo.com/static/media/sl-404.168b1cce.jpg"); // откроем страницу изображения
